...
const AppStoreBadge = () => (
  <svg viewBox="0 0 200 60" className="h-14 w-auto" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" aria-label="Hämta i App Store">
    <rect x="1" y="1" width="198" height="58" rx="10" fill="#000" stroke="#A6A6A6" strokeWidth="1" />
    {/* Apple logo */}
    <path
      transform="translate(18, 14) scale(0.055)"
      fill="#fff"
