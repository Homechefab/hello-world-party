...
const KitchenPartnerApplicationPending = () => {
  return (
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Tack för din ansökan att bli Homechef kökspartner
            </p>
          </div>
            ...
            <CardContent className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-blue-800">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600" />
                    Vi kontrollerar att alla krav är uppfyllda för ditt kök
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600" />
          ...
          <div className="text-center space-y-4">
            <p className="text-sm text-muted-foreground">
              Under tiden kan du utforska vad som väntar dig som kökspartner
            </p>
            <div className="flex gap-4 justify-center">
              <Link to="/kitchen-partner/how-it-works">
...
export default KitchenPartnerApplicationPending;
