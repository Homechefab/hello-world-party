...
const SearchResults = () => {
  ...
  useEffect(() => {
    const searchContent = async () => {
      // For demo purposes, show mock data when there's a search query
      if (query && query.toLowerCase().includes('båstad')) {
        const mockChefs: Chef[] = [
          {
            id: 'chef-1',
            business_name: 'Skånes Smakupplevelse',
            full_name: 'Anna Andersson',
            address: 'Båstad, Skåne',
            dish_count: 8,
            distance: 2.3,
            city: 'Båstad'
          },
          {
            id: 'chef-2',
            business_name: 'Kustens Kök',
            full_name: 'Erik Nilsson',
            address: 'Båstad, Skåne',
            dish_count: 12,
            distance: 1.8,
            city: 'Båstad'
          ...
          {
            id: 'chef-3',
            business_name: 'Hemlagat i Halland',
            full_name: 'Maria Johansson',
            address: 'Halmstad, Halland',
            dish_count: 6,
            distance: 15.2,
            city: 'Halmstad'
          }
        ...
        const mockDishes: Dish[] = [
          {
            id: 'dish-1',
            name: 'Skånsk äppelkaka med vaniljsås',
            description: 'Traditionell skånsk äppelkaka bakad med lokala äpplen och hemgjord vaniljsås',
            price: 89,
            chef_id: 'chef-1',
            chef_name: 'Anna Andersson',
            chef_business_name: 'Skånes Smakupplevelse',
            chef_address: 'Båstad, Skåne',
            distance: 2.3,
            category: 'Efterrätt',
            preparation_time: 45,
          ...
          {
            id: 'dish-2',
            name: 'Kräftpasta med dill',
            description: 'Krämig pasta med färsk kräfta, dill och citron - en riktig sommerfavorit',
            price: 165,
            chef_id: 'chef-2',
            chef_name: 'Erik Nilsson',
            chef_business_name: 'Kustens Kök',
            chef_address: 'Båstad, Skåne',
            distance: 1.8,
            category: 'Huvudrätt',
            preparation_time: 30,
          ...
          },
          {
            ...
            description: 'Klassiska svenska köttbullar med hemgjord gräddsås och lingonsylt',
            price: 125,
            chef_id: 'chef-1',
            chef_name: 'Anna Andersson',
            chef_business_name: 'Skånes Smakupplevelse',
          ...
          {
            id: 'dish-4',
            name: 'Fiskgryta med saffran',
            description: 'Rik fiskgryta med torsk, räkor och musslor i saffransfond',
            price: 189,
            chef_id: 'chef-2',
            chef_name: 'Erik Nilsson',
            chef_business_name: 'Kustens Kök',
