...
// Voice Assistant Premium product ID
const VOICE_ASSISTANT_PRODUCT_ID = "prod_TeAN7CPu5WuQsb";
...
serve(async (req) => {
  ...
  try {
    ...
    // Check if any active subscription is for voice assistant
    ...
    for (const subscription of subscriptions.data) {
      ...
      if (hasVoiceAccess) break;
    }

    if (!hasVoiceAccess) {
      logStep("No voice subscription found");
    }
